...
def run_main():
    ...
    arc = MLArchitect(x_data=exchange_data, y_data=None, is_x_flat=True, save_x_path="saved_data/x.csv",
                      ...
                      window_prediction=4, test_size=0.10, ml_model=None, save_ml_path="saved_data/ml_model.mod")

    # Define the ML model to use
    nb_layers = arc.norm_input_transform(arc.x_test).shape[1]
    ml_model = MultiLayerPerceptronNN(hidden_layer_sizes=(nb_layers*3, nb_layers), activation='logistic',
